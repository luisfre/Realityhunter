...
class InstructivoNivel3 extends Phaser.Scene {

	constructor() {
		super("InstructivoNivel3");
	...
	preload() {
		...
		this.load.image('eugenio', 'assets/personajenivel3.png');
...
moveInSceneActionScriptDurationConfigCompLOGO.duration = 1000; // Duración de 1 segundo
	...
	create() {
		...
		const introText = "Enfrentarás ahora una herramienta poderosa: el detector de noticias basado en inteligencia artificial.\n\n" +
    "Este mecanismo analizará las noticias que recibas, calculando las probabilidades de que sean verdaderas o falsas.\n\n" +
    "Recuerda, la IA es una aliada, pero el juicio final siempre recae en tu capacidad crítica.\n\n" +
    "Ahora, COPIA Y PEGA una noticia, y observa cómo el detector descompone su verdad.\n\n" +
    "¡La verdad te espera, pero solo si tienes el coraje de buscarla!";
